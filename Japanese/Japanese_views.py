...
from Japanese.serializers import JapaneseSerializer
...
Jp_detail_view = ProductDetailAPIView.as_view()
...
Jp_list_create_view = ProductListCreateAPIView.as_view()
...
Jp_put_view = ProductPutAPIView.as_view()
...
Jp_delete_view = ProductDeleteAPIView.as_view()
